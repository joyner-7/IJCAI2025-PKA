...
class IncrementalSamples4cuhk03(IncrementalPersonReIDSamples):
    ...
    def __init__(self, datasets_root, relabel=True, combineall=False, split_id=0, cuhk03_labeled=True,
        ...
        self.data_dir = osp.join(self.dataset_dir, 'cuhk03-np')
        self.raw_mat_path = osp.join(self.data_dir, 'cuhk-03.mat')

        self.imgs_detected_dir = osp.join(self.data_dir, 'detected')
        self.imgs_labeled_dir = osp.join(self.data_dir, 'labeled')
