...
class IncrementalSamples4cuhksysu(IncrementalPersonReIDSamples):
    ...
    def __init__(self, datasets_root, relabel=True, combineall=False):
        ...
        self.dataset_dir = osp.join(self.root, 'newcuhk_sysu')
        self.data_path = osp.join(self.dataset_dir,'dataset' ,'Image', 'SSM')
        self.annotation_path = osp.join(self.dataset_dir,'dataset','annotation')
        self.processed_dir = osp.join(self.root, 'newcuhk_sysu','cuhksysu4reid')
...
class IncrementalSamples4subcuhksysu(IncrementalPersonReIDSamples):
    ...
    def __init__(self, datasets_root, relabel=True, combineall=False, use_subset_train=True):
        ...
        self.dataset_dir = osp.join(self.root, 'newcuhk_sysu','dataset')
...
class CUHKSYSU(ImageDataset):
    ...
    def __init__(self, root='/data0/data_lzj', **kwargs):
